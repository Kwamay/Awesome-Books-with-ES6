...
```sh
git clone https://github.com/Kwamay/awesome-books-with-es6
```

then you will see the **awesome-books-with-es6** on your system then type this:
...
Feel free to check the [issues page](https://github.com/kwamay/awesome-books-with-es6/issues).
